$(document).ready(() => {
    ...
    function GetMessage(polygon) {
        ...
        message += '<p><a href="#" id="edit-polygon" class="btn btn-warning m-3">Edit</a> '
            + '<a href="#" id="save-polygon" class="btn btn-success m-3">Done</a> '
            + '<a href="#" id="delete-polygon" class="btn btn-warning m-3">Delete</a></p>'
            + coordinateMessage;
