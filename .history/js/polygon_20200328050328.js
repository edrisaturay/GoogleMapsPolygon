$(document).ready(() => {
    ...
    function FieldClickListener() {
        google.maps.event.addListener(
            ...
            function(event) {
                ...
                google.maps.event.addListener(myInfoWindow, 'domready')
            }
        );
    }
    ...
    function GetMessage(polygon) {
        ...
        message += '<p class="mt-3"><a href="#" onclick="test()" class="btn btn-sm btn-warning mr-2">Edit</a> '
            + '<a href="#" onclick="test()" class="btn btn-sm btn-success mr-2">Done</a> '
            + '<a href="#" onclick="test()" class="btn btn-sm btn-danger mr-2">Delete</a></p>'
            + coordinateMessage;
    ...
    /**
     * Event listeners for the polygon popup
     */



    $("a#edit-polygon").on("click", () => {
        console.log("polygon edit click")
    })
