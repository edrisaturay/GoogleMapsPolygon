$(document).ready(() => {
    ...
    function GetMessage(polygon) {
        ...
        message += '<p class="mt-3"><a href="#" onclick="edit-polygon" class="btn btn-sm btn-warning mr-2">Edit</a> '
            + '<a href="#" onclick="save-polygon" class="btn btn-sm btn-success mr-2">Done</a> '
