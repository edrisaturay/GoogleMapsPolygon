$(document).ready(() => {
    ...
    // show drawing tools
    getCurrentLocation();
    var geoloccontrol = new klokantech.GeolocationControl(myMap, mapMaxZoom);
    ...
    function FieldDrawingCompletionListener() {
        ...
        google.maps.event.addListener(
            ...
            (polygon) => {
                ...
                FieldClickListener();
                GenerateSelectBoxes(myField);
                AddAdditionalEventListeners(myField)
            }
        );
    }
    ...
    function GenerateSelectBoxes(polygon){
        var boxesWrapper = $("#selected-field");
        boxesWrapper.empty();
